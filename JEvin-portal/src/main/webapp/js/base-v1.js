 ...
 */
function login() {
    return location.href = "http://www.jvshop.com/page/login.shtml";
}
function regist() {
    return location.href = "http://www.jvshop.com/page/register.shtml";
}
...
function search(a) {
    var b = "http://search.jvshop.com/search.shtml?q=" + encodeURIComponent(document.getElementById(a).value);
